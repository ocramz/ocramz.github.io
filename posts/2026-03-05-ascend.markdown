---
layout: post
title: "ascend ⬆️☁️ : run Python functions on Kubernetes"
date: 2026-03-05
...
This post describes `ascend`, a library I built to offer the convenience of the above approaches, while incurring as few of the drawbacks as possible. The code is open source as of today and available [here](https://github.com/ocramz/ascend).
...
I was kindly [reminded](https://bsky.app/profile/zzstoatzz.io/post/3mgdrkybiws2h) that Prefect [supports](https://docs.prefect.io/v3/advanced/submit-flows-directly-to-dynamic-infrastructure#customizing-infrastructure-configuration) this style of dynamic provisioning, in addition to being self-hostable. 