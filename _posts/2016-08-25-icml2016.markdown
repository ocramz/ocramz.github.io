...
<p align="center">
    <object data="https://rawgithub.com/ocramz/ocramz.github.io/blob/master/_posts/viz.svg" type="image/svg+xml" width="600"> </object>
</p>
...
pointToP2 (Lib.P x y) = p2 (f2d x, f2d y)
